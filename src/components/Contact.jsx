...
const Contact = () => {
  return (
    <div id='contact' name='contact' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 pt-96 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <form action="https://getform.io/f/3e1ff49d-f7f3-4cda-ae7d-c3d7e39f99f4" method='POST' className='flex flex-col w-full md:w-1/2'>
